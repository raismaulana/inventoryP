...
// showRoomInventoryHandler ...
func (r *Controller) showRoomInventoryHandler(inputPort showroominventory.Inport) gin.HandlerFunc {

	return func(c *gin.Context) {

		ctx := log.ContextWithLogGroupID(c.Request.Context())

		var req showroominventory.InportRequest
